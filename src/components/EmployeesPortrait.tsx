import { Avatar, IconButton, Spinner, Stack, Table, Text } from "@chakra-ui/react";
            ...
            <Table.Body>
              {sortedEmployees.map((empl) => (
                <Table.Row key={empl.id} >
                  ...
                  <Table.Cell><IconButton bg="white" color="black"><BsThreeDots></BsThreeDots></IconButton></Table.Cell>
                </Table.Row>
              ))}
            </Table.Body>
          </Table.Root>
